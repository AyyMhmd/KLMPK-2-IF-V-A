    ...
    <main>
        ...
        <div class="container text-center konten-main">
            ...
            <div class="container text-center konten-1 mt-3 mb-5">
                <h2 class="text-success">Sejarah STT CIPASUNG</h2>
                <a>
                    ...
                    perhatian.
                    <a href="src/sejarah.html"> Baca lebih lanjut... </a>
                </a>
            </div>
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    masyarakat di sekitar pesantren dan daerah pinggiran yang
                                    selama ini kurang mendapatkan perhatian.
                                    <a href="src/bio_pa_ade.html"> Baca lebih lanjut... </a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container text-center mb-5">
                <h2 class="text-success">FACULTY</h2>
                <!-- content split -->
                    ...
                    <div class="col-xl-6 mb-3 mb-sm-0 row-two">
                        <div class="card-faculty mx-auto">
                            ...
                            <div class="card-content">
                                ...
                                <a href="/src/ti.html" class="button">
                                    Find out more
                                    <span class="material-symbols-outlined">arrow_right_alt</span>
                                </a>
                            </div>
            ...
            <div class="container text-center mb-5">
                <h2 class="text-success">Prestasi Mahasiswa</h2>
            ...
            <!-- content 5 calendar -->
            <div class="container text-center mb-5">
                <h2 class="text-success">Events and Academic Calendar</h2>
                <div class="row">
            ...
            <!-- content 6 ukm -->
            <div class="container text-center mb-5">
                <h2 class="text-success mb-4">Unit Kegiatan Mahasiswa</h2>
